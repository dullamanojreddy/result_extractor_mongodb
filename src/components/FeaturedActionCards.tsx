...
export const FeaturedActionCards: React.FC<FeaturedActionCardsProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 mb-6">
      {/* CARD 1: CLASS RESULT */}
      <div className="relative overflow-hidden bg-[#F5F3FF] dark:bg-[#121212] border border-[#E9D5FF] dark:border-neutral-800 rounded-3xl p-5 sm:p-6 flex flex-col justify-between transition-all hover:shadow-md min-w-0">
        ...
        <div className="min-w-0">
          <div className="flex items-center justify-between mb-4 gap-2">
            <div className="w-11 h-11 rounded-2xl bg-[#7C3AED] text-white flex items-center justify-center shadow-md shadow-purple-500/20 shrink-0">
          ...
          <h2 className="text-lg sm:text-xl font-black text-slate-900 dark:text-white tracking-tight mb-2">
            Class Result
          </h2>
